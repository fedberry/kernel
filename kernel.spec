...
%changelog
* Sat Dec 01 2018 Vaughan <devel at agrez dot net> - 4.14.84-1
- Update to stable kernel patch v4.14.84
- Sync RPi patch to git revision: 325e4d0c485a8209df3be4a75796eac208bdd6e9

* Tue Nov 20 2018 Vaughan <devel at agrez dot net> - 4.14.81-1
- Update to stable kernel patch v4.14.81
- Sync RPi patch to git revision: f6878de4d2818c2256b2a340eaeeabfb0b24c71b
...
* Thu Oct 04 2018 Vaughan <devel at agrez dot net> - 4.14.73-1
- Update to stable kernel patch v4.14.73
- Sync RPi patch to git revision: e24b1f6c0c798508981c7c5f59a5d76ce6fe58e1

* Wed Sep 26 2018 Vaughan <devel at agrez dot net> - 4.14.71-1
- Update to stable kernel patch v4.14.71
- Sync RPi patch to git revision: df493abeaf1b0a2a83ebe21262758f802e567a38

* Tue Sep 18 2018 Vaughan <devel at agrez dot net> - 4.14.70-1
- Update to stable kernel patch v4.14.70
- Sync RPi patch to git revision: 74f7a305a189d88c506fbc0e22a491d71852c7df

* Tue Sep 11 2018 Vaughan <devel at agrez dot net> - 4.14.69-1
- Update to stable kernel patch v4.14.69
- Sync RPi patch to git revision: 27e84c625ebbdfccf78220f2f90995a050c7b64a

* Sat Sep 01 2018 Vaughan <devel at agrez dot net> - 4.14.67-1
- Update to stable kernel patch v4.14.67
- Sync RPi patch to git revision: 0f937c8dc3201ebffa6c617c616fd7c65db65959

* Thu Aug 23 2018 Vaughan <devel at agrez dot net> - 4.14.66-1
- Update to stable kernel patch v4.14.66
- Sync RPi patch to git revision: c90694c0d90f01059550b7a70aee7f19a2fc37e4

* Thu Aug 09 2018 Vaughan <devel at agrez dot net> - 4.14.61-1
- Update to stable kernel patch v4.14.61
- Sync RPi patch to git revision: 52d350fb107dbd9fa30d44685ed52d2c52b09d96
