...
%global rpi_gitshort 094cde88

%global fedora_build %{baserelease}

# Real-Time kernel defines
%global rtrelease 37
%global rt_stable_update 47
...
* Wed Nov 01 2017 Vaughan <devel at agrez dot net> - 4.9.59-1
- Update to stable kernel patch v4.9.59
- Update RPi patch to git commit: 90d58142df6e71192cf16a9a57e376d38b685bb4

* Tue Oct 17 2017 Vaughan <devel at agrez dot net> - 4.9.56-1
- Update to stable kernel patch v4.9.56
- Update RPi patch to git commit: 8ae9fe37185111fd006f314ce6c2bea91b30d090
...
- Update RPi patch to git commit: 46e2d4d1bd2c17e2f84dd90768321ee0bbaa6b8a

* Sun Sep 10 2017 Vaughan <devel at agrez dot net> - 4.9.48-1
- Update to stable kernel patch v4.9.48
- Update RPi patch to git commit: 41d3258f63227f079d0542bbbd58fd666a145e51

* Sun Aug 27 2017 Vaughan <devel at agrez dot net> - 4.9.45-1
- Update to stable kernel patch v4.9.45
- Update RPi patch to git commit: 3ce72830a8c8bba33c37ebe4bee71ac3177451b0

* Tue Aug 15 2017 Vaughan <devel at agrez dot net> - 4.9.43-1
- Update to stable kernel patch v4.9.43
- Update RPi patch to git commit: 5433720f3e8d6d06a59b30cce44210d814f34b0b

* Mon Aug 07 2017 Vaughan <devel at agrez dot net> - 4.9.41-1
- Update to stable kernel patch v4.9.41
- Update to RT PREEMPT kernel v4.9.40-rt30 patchset release
- Update RPi patch to git commit: a6d7c7353dfd938f8f5c6d6f33813f2c4b3ff7dc


* Sat Jul 22 2017 Vaughan <devel at agrez dot net> - 4.9.39-1
- Update to stable kernel patch v4.9.39
- Update RPi patch to git commit: 89c9c0b085c5dc175d72438e5e86c37b2b558bf2

* Tue Jul 18 2017 Vaughan <devel at agrez dot net> - 4.9.38-1
- Update to stable kernel patch v4.9.38
- Update to RT PREEMPT kernel v4.9.35-rt25 patchset release
- Update RPi patch to git commit: 3d2fc07ef35db2a10cc259b263ae7250d00e487d
